 ...
 * @LastEditTime: 2022-07-05 14:33:35
 * @FilePath: \web_wxChat\src\api\modules\controlConsole\timedTask.ts
...
// 删除任务
export const deleteTask = (ids: string | number) => service.get(`/wechat/web/client/deleteTask?ids=${ids}`);
// 获取所有企微账号
...
export const updateTaskStatus = (obj: object) => service.post('/wechat/web/client/updateTaskStatus', obj);
