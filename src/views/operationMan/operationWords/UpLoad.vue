<!--
 * @Author: your name
 * @Date: 2022-04-06 17:04:19
 * @LastEditTime: 2022-04-13 10:19:51
 * @LastEditors: Please set LastEditors
 * @Description: 打开koroFileHeader查看配置 进行设置: https://github.com/OBKoro1/koro1FileHeader/wiki/%E9%85%8D%E7%BD%AE
 * @FilePath: \v3ts_admin\src\views\verbalTRStock\UpLoad.vue
-->
<template>
    <div class="upload">
        <el-upload ref="upload" :action="action" list-type="picture-card" :file-list="fileList" :auto-upload="true"
            multiple :on-success="handleSuccess" :before-upload="beforeUpload" :on-preview="handlePictureCardPreview"
            show-file-list :data="postData">
        ...
        <el-dialog v-if="dialogVisible" v-model="dialogVisible" :append-to-body="true">
            <div v-if="isVideo(dialogImageUrl)">
                <video id="upvideo" :src="dialogImageUrl" style="width: 100%; height: 100%"
                    controls>您的浏览器不支持视频播放</video>
            </div>
...
const props = defineProps(["token", 'list'])
const uuid = v4
